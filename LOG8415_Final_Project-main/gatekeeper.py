...
class Orchestrator:
    ...
    def deployFlaskApp(self):
        ...
        try:
            ...
            self.connection.run('mkdir -p gatekeeper')
            self.connection.put('gatekeeper_setup/gatekeeper.sh', remote='/home/ubuntu/gatekeeper')
            self.connection.put('gatekeeper_setup/gatekeeper.py', remote='/home/ubuntu/gatekeeper')
